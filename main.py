...
if __name__ == "__main__":
    ...
    print("-------------------------- RESULTS --------------------------")
    print("-------------------------------------------------------------")
    print('Train OA: {: 0.4f} AA: {: 0.4f} Kappa: {: 0.6f}'.format(res[0], res[1], res[2]))
    print(' Test OA: {: 0.4f} AA: {: 0.4f} Kappa: {: 0.6f}'.format(res[3], res[4], res[5]))
    print("-------------------------------------------------------------")
    print("Mean Average Precision : {:0.6f}".format(res_map))
